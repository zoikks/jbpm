...
public class HumanTaskService {
	...
	public void start(HumanTaskSupport htSupport) {
		...
		if (!this.started) {
	        ...
	        // start server
	        this.taskServer = new MinaTaskServer(taskService, htSupport.port(), htSupport.host());
	...
	public void start(Properties jbpmTestConfiguration) {
		...
		if (!this.started) {
	        ...
	        // start server
	        this.taskServer = new MinaTaskServer(taskService, port, jbpmTestConfiguration.getProperty(ConfigurationHelper.HUMAN_TASK_HOST, "localhost"));
	        this.serverThread = new TaskServerThread(taskServer);
	        serverThread.start();
	        this.setStarted(true);
